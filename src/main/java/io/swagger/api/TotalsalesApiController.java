...
@RestController
public class TotalsalesApiController implements TotalsalesApi {

    private static final Logger log = LoggerFactory.getLogger(TotalsalesApiController.class);
    ...
    public TotalsalesApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Sale> totalsalesGet() {
