...
@RestController
public class CountsalesApiController implements CountsalesApi {

    private static final Logger log = LoggerFactory.getLogger(CountsalesApiController.class);
    ...
    public CountsalesApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Sale> countsalesGet() {
